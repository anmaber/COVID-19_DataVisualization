...
mv time_series_covid19_confirmed_global.csv confirmed.csv
...
mv time_series_covid19_deaths_global.csv deaths.csv
...
mv time_series_covid19_recovered_global.csv recovered.csv
